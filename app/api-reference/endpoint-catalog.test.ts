  ...
  it("documents developer and website endpoint groups without listing detailed admin APIs", () => {
    ...
    expect(flatEndpointKeys()).toEqual(
      expect.arrayContaining([
        ...
        "POST /v1/prism/slack/inbound-routes prismDeveloperToken local-tool",
        "DELETE /v1/prism/slack/inbound-routes/{routeId} prismDeveloperToken local-tool",
        "GET /v1/prism/slack/inbox prismDeveloperToken local-tool",
        "POST /v1/prism/slack/inbox/{deliveryId}/ack prismDeveloperToken local-tool",
