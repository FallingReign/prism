...
import { revokeAdminTokenProfile } from "../../../../../../../../../src/server/admin/token-profile-actions";
...
export async function POST(request: NextRequest, context: RouteContext): Promise<NextResponse> {
  ...
  try {
    ...
    if (result.kind === "revoked") return noStoreJson({ profile: result.profile, scope: result.scope }, 200, requestId);
...
function actionError(result: Exclude<Awaited<ReturnType<typeof revokeAdminTokenProfile>>, { kind: "revoked" }>, requestId: string): NextResponse {
