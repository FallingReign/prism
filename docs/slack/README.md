...
These artefacts are docs/config only. OAuth routes and encrypted credential custody are implemented by issue #4; Method registry and Slack API forwarding remain deferred.
